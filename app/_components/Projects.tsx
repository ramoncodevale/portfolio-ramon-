...
const PROJECTS_DATA: Project[] = [
  {
    ...
    description:
      'Um sistema para agendamento de cortes de cabelo e serviços de barbearia.',
    image:
  ...
  },
  {
    ...
    description:
      'Aplicação inspirada no Spotify, desenvolvida com React e JavaScript.',
    image:
      'https://images.unsplash.com/photo-1611339555312-e607c8352fd7?q=80&w=1374&auto=format&fit=crop',
    ...
    <section id="projects" className="py-24 relative">
      <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
        <div>
          ...
          <h2 className="font-heading text-5xl md:text-7xl font-black text-[#E6E8EC] leading-none">
            TRABALHOS <br />
            <span className="text-[#7CFFB2]">SELECIONADOS.</span>
          </h2>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {PROJECTS_DATA.map((project) => (
          <div
            key={project.id}
            className="group relative rounded-[40px] overflow-hidden glass p-4 transition-all hover:-translate-y-2"
          >
            ...
            <div className="px-4 pb-4">
              <div className="flex flex-wrap gap-2 mb-4">
                {project.stack.map((tech) => (
                  <span
                    key={tech}
                    className="text-[10px] font-bold text-[#7CFFB2] px-2 py-1 rounded bg-[#7CFFB2]/10"
                  >
                    {tech}
                  </span>
                ))}
              ...
              <p className="text-[#9CA3AF] text-sm mb-6 leading-relaxed line-clamp-2">
                {project.description}
              </p>
              ...
              <div className="flex gap-6">
                <a
                  ...
                  className="flex items-center gap-2 text-sm font-bold text-white hover:text-[#7CFFB2] transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-sm font-bold text-[#9CA3AF] hover:text-white transition-colors"
                >
