  ...
  return (
    <section className="relative min-h-[95vh] flex flex-col justify-center pt-32 pb-20 overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: `
            linear-gradient(to right, #7CFFB20d 1px, transparent 1px),
            linear-gradient(to bottom, #7CFFB20d 1px, transparent 1px)
          `,
      ...
      <div className="grid lg:grid-cols-12 gap-12 items-center relative z-10">
        <div className="lg:col-span-8">
          ...
          <h1 className="font-heading text-6xl md:text-8xl lg:text-[115px] font-black tracking-tighter leading-[0.95] mb-12 text-[#E6E8EC]">
            ...
            <span className="relative inline-block text-[#7CFFB2]">
              DIGITAIS
              <span className="absolute -bottom-4 left-0 w-full h-1.5 bg-[#7CFFB2] rounded-full opacity-20" />
            </span>
          </h1>
          ...
          <div className="flex flex-wrap gap-6 items-center">
            <a
              ...
              className="group inline-flex items-center gap-4 px-10 py-5 bg-[#7CFFB2] text-black rounded-xl font-bold text-lg transition-all hover:scale-105 active:scale-95 shadow-[0_10px_40px_-10px_rgba(124,255,178,0.3)]"
            >
            ...
            >
              Entrar em contato
              <span className="w-8 h-[1px] bg-white/20 group-hover:w-12 group-hover:bg-[#7CFFB2] transition-all" />
            </a>
          </div>
        </div>
        ...
        <div className="lg:col-span-4 relative hidden lg:block">
          <div className="relative w-full aspect-square">
            <div className="absolute inset-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 border border-white/5 rounded-full" />
            <div className="absolute inset-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 border border-dashed border-[#7CFFB2]/20 rounded-full animate-[spin_30s_linear_infinite]" />
            ...
            <div className="absolute top-0 -right-4 w-72 p-6 rounded-2xl bg-[#0d111a] border border-white/10 shadow-2xl animate-[float_7s_infinite_alternate]">
              ...
              <p className="text-[11px] text-[#9CA3AF] italic">
                "Interfaces que respiram e guiam o usuário com clareza."
              </p>
            </div>
            ...
            <div className="absolute bottom-12 -left-8 w-64 p-6 rounded-2xl bg-[#0d111a] border border-white/10 shadow-2xl animate-[float_9s_infinite_alternate-reverse]">
              <div className="flex gap-4 mb-4">
                <div className="w-10 h-10 rounded-xl bg-[#7CFFB2]/20 flex items-center justify-center">
                  <Zap className="w-5 h-5 text-[#7CFFB2]" />
                </div>
                <div className="flex-1">
                  <div className="flex justify-between text-[8px] font-bold mb-1">
                    <span className="text-[#7CFFB2]">PERFORMANCE</span>
                    <span className="text-white">99%</span>
                  </div>
                  <div className="h-1 bg-white/5 rounded-full overflow-hidden">
                    <div className="h-full w-[99%] bg-[#7CFFB2]" />
                  </div>
                </div>
              </div>
            ...
            <div className="absolute top-1/3 left-0 p-3 rounded-lg bg-white/5 border border-white/10 animate-bounce">
